...
def get_ip(malicious_ratio: float = 0.35):
    # Inject IPsum entries regularly so the dashboard can show malicious hits.
...
def make_event():
    # get a client IP (biased toward IPsum values to surface malicious hits)
